...
class User extends CI_Controller {
	...
	public function menu2(){
		//load data menu
		$data['menu']=$this->data->get_menu2(12,0);
		//first paging
		$data['count']=12; 
		$this->load->view('user_vw/meta');
		$this->load->view('user_vw/js');
	...
	public function load_more($lastid,$limit){
		...
		foreach ($data as $menu) {
			echo "<div class='menu col-3 col-sm-4'>"
				    ."<div class='thumbnail'>"
  	...
  	public function load_more_data($lastid,$limit){
		$data=$this->data->get_menu($limit, $lastid);
		foreach ($data as $menu) {
			echo "<div class='menu col-3 col-sm-4'>"
				    ."<div class='thumbnail'>"
	...
	public function paket_menu($paket){
		switch ($paket) {
			case 'pagi':
				$data['menu'] =$this->data->get_set_menu();
	...
	public function data_menu2(){
		...
		$kirim['itemcart']=$this->cart->total_items();
		//$this->load->view('user_vw/navbar',$kirim);
		 $this->load->view('user_vw/data_menu',$data);
      	//$this->load->view('user_vw/menu',$data);
		//$this->load->view('user_vw/footer');
	}
  	public function data_menu(){
		//$data['menu']=$this->data->get_menu_rand();
      	$data['menu']=$this->data->get_menu_set();
		//first paging
		$data['count']=12;
		$this->load->view('user_vw/meta');
		$this->load->view('user_vw/js');
