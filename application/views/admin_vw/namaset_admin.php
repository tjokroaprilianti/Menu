<!-- Page Content -->
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h4>LIHAT ATAU TAMBAH SET MENU</h4>

    <div class="panel panel-default">
        <div class="panel-heading">
        <div class="row">
            <div class="col-md-7"><b>Data Nama Set Tersedia</b></div>
            <div class="col-md-3 text-right">
            <form style="margin-bottom: 0px" id="cari" action="<?php echo base_url('admin/search_namaset');?>" method="GET">
        ...
        <thead>
            <tr>
                ...
                <th class="text-center">Kd Set</th>
                <th class="text-center">Nama Set</th>
               <!--  <th class="text-center">Kd Menu</th>
                <th class="text-center">Kd Set</th>        
                <th class="text-center">Kd_jenis</th>   
                <th class="text-center">kd_paket</th>
                <th class="text-center">Nama_paket</th> -->
        ...
        <?php } else {
           ...
           foreach ($menu as $data) {?>
               <tr>
                   ...
                   <td class="text-center"><?php echo $data->kd_set; ?></td>
                   <td class="text-center"><?php echo $data->nama_set; ?></td>
                   <!-- <td class="text-center"><?php //echo $data->kd_menu;?></td>
                   <td class="text-left"><?php //echo $data->kd_set;?></td>
                  <td class="text-left"><?php //echo $data->kd_jenis;?></td>
                  <td class="text-left"><?php //echo $data->kd_paket;?></td>
