<!-- Page Content -->
    ...
    <div id="page-content-wrapper">
        <div class="container-fluid">
            <h4>LIHAT ATAU TAMBAH JENIS SET</h4>

    <div class="panel panel-default">
        <div class="panel-heading">
        <div class="row">
            <div class="col-md-7"><b>Data Jenis Set Tersedia</b></div>
            <div class="col-md-3 text-right">
            <form style="margin-bottom: 0px" id="cari" action="<?php echo base_url('admin/search_jenisset');?>" method="GET">
        ...
        <thead>
            <tr>
                ...
                <th class="text-center">Nama Jenis Set</th>
           ...
           foreach ($menu as $data) {?>
               <tr>
                   <td class="text-center"><?php echo $no;?></td>
                    <td class="text-center"><?php echo $data->kd_jenis; ?></td> 
