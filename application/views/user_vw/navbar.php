	  ...
	  <div class="container-fluid">
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="<?php echo base_url('/home.html') ?>">
	      	 ...
	      	 <img width="90" alt="Brand" src="<?php echo base_url('/asset/img/logo_aps.png')?>">
	      </a>
	    </div>
	    <div class="collapse navbar-collapse" id="myNavbar">
	      <ul class="nav navbar-nav navbar-right">
	      	<li class="active"><a id="nav-menu" href="<?php echo base_url('/lihat-menu.html')?>">Menu Pesanan</a></li>
