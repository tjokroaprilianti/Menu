		...
		<form id="invoice" action="prosesed.html" class="form-horizontal" method="POST" target="_blank">
			...
			<div class="col-md-9">
				  <div  class="form-group">
				    <!-- <label type="hidden" class="label-left col-sm-offset-1 col-sm-3">Nama Asli</label> -->
				    <div class="col-sm-8"> 
				      <input type="hidden" id="nama" name="nama" class="form-control"  value="<?php if(isset($invoice)) echo $invoice[0]->nama;?>">
				    </div>
				  </div>
				  <div class="form-group">
				   <!--  <label class="label-left col-sm-offset-1 col-sm-3">Alamat Rumah (Pengiriman)</label> -->
				    <div class="col-sm-8"> 
				      <input  type="hidden" id="alamat" name="alamat" class="form-control" value="<?php if(isset($invoice)) echo $invoice[0]->alamat;?>">
				    </div>
				  </div>
				  <div  class="form-group">
				    <!-- <label type="hidden" class="label-left col-sm-offset-1 col-sm-3">Kode POS</label> -->
				    <div class="col-sm-8"> 
				      <input type="hidden" id="kd_post" name="kd_pos" class="form-control"  value="<?php if(isset($invoice)) echo $invoice[0]->kd_pos;?>">
				    </div>
				  </div>
				  <div class="form-group">
				  ...
				  <div class="form-group">
				    ...
				    <div class="col-sm-8"> 
				     <div class="radio">
					  <label><input type="radio" name="metode" value="0">Ambil Sendiri</label>
					 </div>
					 <div class="radio">
					  <label><input type="radio" name="metode" value="1" checked>Antar Pesanan</label>
					 </div>
				     </div>
				  </div>
			</div>
